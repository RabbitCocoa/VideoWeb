...
<script>
    ...
    table.render({
        ...
        ,cols: [[ //标题栏
            ...
            ,{field: 'total', title: '总播放量', width: 160, sort: true}
            ,{field: 'LoginTime', title: '上传时间', minwidth: 60, sort: true}
            ,{field: 'status', title: '状态', width: 160 }
            ,{field: 'tempId', title: '操作',width: 120, templet: function(d){
                    return '<a class="layui-btn layui-btn-xs layui-btn-danger"  onclick="del(1001)"><i class="layui-icon layui-icon-face-surprised"></i>封禁</a>';
                }}
        ]]
        ,data: [{
            "id": "10001"
